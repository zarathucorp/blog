---
title: "AFROC vs. JAFROC: MRMC 연구의 올바른 통계 분석"
description: |
...
2.  **독자 변동성 (Reader Variability)**: 어떤 판독자는 전반적으로 실력이 좋고, 어떤 의사는 안 좋습니다.
...
\qquad 
\tilde P_{ijk} \;=\; P_{ijk} - \hat{\theta}_{ij}.
$$
