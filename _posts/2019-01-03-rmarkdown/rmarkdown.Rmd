...
3. 웹(`html`): 웹사이트나 블로그를 만든다. **[blogdown](https://github.com/rstudio/blogdown)**^[https://github.com/rstudio/blogdown] 이나 **[radix](https://rstudio.github.io/radix/)**^[https://rstudio.github.io/radix/] 패키지가 대표적이다. 이 글의 블로그도 **[radix](https://rstudio.github.io/radix/)**로 만들었으며, [Anpanman 홈페이지](https://www.anpanman.co.kr/)는 **[blogdown](https://github.com/rstudio/blogdown)**을 이용하였다.
