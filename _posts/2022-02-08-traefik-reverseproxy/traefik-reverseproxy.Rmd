...
<img src="./Traefik-dashboard.PNG">

<br>

### __docker-compose.yml 파일 작성__
...
<img src="./traefik-architecture.png">
...
route1: 
  ...
  tls: {}
```
entrypoints가 websecure로 들어오는 요청(:443포트로 들어오는 요청)에 대해서 만약 'food.dogdog.cf/toy' 요청이면 reverse-proxy라는 서비스로 넘기며 해당 서비스의 내용을 수행하며. tls(https 서비스)를 사용하겠다는 코드입니다.
